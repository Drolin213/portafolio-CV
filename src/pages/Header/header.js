    ...
    return (
        ...
        <img src={logo} alt="Logo" />
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/Drolin213" target="_blank">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/david-lozano-7166a6205/" target="_blank">
...
<p>LinkedIn</p>
                ...
                <a className="twitter" href="https://twitter.com/DrolinLd26" target="_blank">
...
<p>Twitter</p>
                ...
                <a className="schedule" href="https://allmylinks.com/drolin-ld26" target="_blank">
...
<p>Contact me</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-four"><a className="nav-link" href="https://drive.google.com/file/d/1JKPaFX3vwB1xKqMk_F9lIQlbvvnRqWE1/view?usp=sharing" target="_blank">Resume</a></li>
